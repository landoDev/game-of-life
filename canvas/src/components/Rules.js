...
const Rules = () => {
    return (
        <RulesContainer className="rules-container">
            ...
            <p>I put my name in the title of this iteration, but alas, I'm far from the mathemtician that invented this little number. I do, however, have access to his rules and how this game works.</p>
            <div className="rules">
                <p>Rule 1: if a cell hass less than two surrounding cells, it will DIE <span role="img" aria-label="skull">💀</span></p>
                <p>Rule 2: If a cell has more than three surrounding celss, IT WILL DIE <span role="img" aria-label="skull">💀</span></p>
